...
nbox_quants <- nbox_names_sub %>% mutate(quant_lg_alltime = NA, quant_lg_szn = NA, quant_p_alltime = NA, quant_p_szn = NA) %>% arrange(Person_id, Season, -PIE)

for(i in 1:nrow(nbox_quants)){
  ...
  #WHEN THIS FINISHES RUNNING FIX YOUR PLAYER SEASONS
  #IT IS CURRENTLY EQUAL TO LEAGUE SEASON
  #CHANGING ONE COL. SHOULD NOT TAKE NEARLY AS LONG :)
