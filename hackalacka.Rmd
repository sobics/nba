...
library(dplyr)
box <- read.csv("C:/Users/Nathaniel Brown/Documents/important things/nbahack2017/Basketball Data/Player_Boxscores.csv")
...
nbox <- nbox %>% mutate(top30 = (Person_id %in% top30players))
